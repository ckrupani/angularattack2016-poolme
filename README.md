...
* `git clone git@github.com:rumblex/angularattack2016-poolme.git`

* `cd angularattack2016-poolme`
...
If you receive an error message `"You do not have permission to publish to poolme.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add chiragrupani2004@gmail.com`
